...
const CoverModal = ({ blok, closeModal }) => {
  ...
  return (
    <div className="fixed z-[100] top-0 left-0 w-screen h-screen">
      <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 h-full w-[calc(100vw-20px)] lg:w-[calc(100vw-100px)] bg-white pt-10 pb-32 px-4 lg:p-24">
        ...
        <div className="px-3 py-5 max-w-[1920px] overflow-y-scroll h-full">
          <StoryblokComponent
            blok={blok?.find(
